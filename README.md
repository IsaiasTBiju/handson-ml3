Forked from Aurelien Geron's Machine Learning Notebooks, 3rd edition by Isaias Thomas Biju
=================================

This repository teaches the fundamentals of Machine Learning in python. It contains the example code and solutions to the exercises in the third edition of Geron's O'Reilly book [Hands-on Machine Learning with Scikit-Learn, Keras and TensorFlow (3rd edition)](https://homl.info/er3):
